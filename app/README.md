...
5. When it says **Pinned** plus the shell version (Grown-Ups → Device, currently `rsabc-shell-v45-letter-names`), you can turn the radio off.
...
- PIN **`1234`**
- Shell pin **`rsabc-shell-v45-letter-names`** (Grown-Ups → Device)
