...
5. When it says **Pinned** plus the shell version (Grown-Ups → Device, currently `rsabc-shell-v43-voice-clips`), you can turn the radio off.
...
| *Only 66 of 261 files are cached…* | Chrome evicted part of it (usually a full disk). | Back on Wi-Fi, tap **Set up this device**. |
...
- PIN **`1234`**
- Shell pin **`rsabc-shell-v43-voice-clips`** (Grown-Ups → Device)
