...
Shell pin for this drop: **`rsabc-shell-v37-lucy-voice`**

**What is new in this one:** Lucy speaks the ten mapped cheer and nudge
clips. The xylophone celebrate sting still plays. Names, letter sounds, and
words stay silent. Home, Grown-Ups PIN, and Music / SFX / Voice mutes stay.
Tablets that already have an older pin need step 4 below.
...
5. Wait for it to say **Pinned `rsabc-shell-v37-lucy-voice`**.
