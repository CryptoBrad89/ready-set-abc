...
It should say all **506** files. Chrome sometimes throws files away when a
...
| "Only 66 of 506 files are cached" | Chrome evicted some. Back on Wi-Fi, tap **Set up this device** |
