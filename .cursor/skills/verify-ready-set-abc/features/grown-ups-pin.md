...
- Navigate to `verify-rsabc smoke 'reset=1&kid=k01&gu=play'`.
...
- Assigned Play hides the Open clouds row. SATPIN Play still shows it. Prove both if Class mutation is in scope.
